          ...
          <div className="preview-wrap">
            <div className="slip">
              <div className="slip-content">
                ...
                <div  className="value bold"  style={{left: '430pt',    top: '228pt',width: '135pt',textAlign: 'right', fontWeight: 700,}}>{form.netWeight}</div>
                ...
                <div  className="value bold"  style={{left:'430pt',top:'272pt',width: '135pt',textAlign: 'right',fontWeight: 700,}}>{form.remainWeight}</div>
